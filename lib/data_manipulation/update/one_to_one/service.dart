...
class OneToOneUpdateService with DartStoreUtility {
  ...
  Future _updateConnection(
    ...
    final statement =
        "INSERT INTO $connectionName (${updatedEntityInstance.tableName}, ${instance2.tableName}) VALUES (${pKey1.dataType.convert(pKey1.value)}, ${pKey2.dataType.convert(pKey2.value)}) ON CONFLICT(${instance2.tableName}) DO UPDATE SET ${instance2.tableName} = EXCLUDED.${pKey2.dataType.convert(pKey2.value)} WHERE $connectionName.${instance2.tableName} = ${pKey2.dataType.convert(pKey2.value)}";
    print(statement);
    try {
